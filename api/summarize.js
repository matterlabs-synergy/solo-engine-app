...
if (!apiKey) return res.status(500).json({ error: 'OpenAI API key missing in Vercel settings.' });

// UNIVERSAL SCRAPER LAYER: Extracts actual text information if a user inputs a URL link
let finalPayloadText = url;
if (url.startsWith('http://') {https://')) {
{
{
{
https://jina.ai{encodeURIComponent(urhttps://jina.ai{encodeURIComponent(url)}`,
